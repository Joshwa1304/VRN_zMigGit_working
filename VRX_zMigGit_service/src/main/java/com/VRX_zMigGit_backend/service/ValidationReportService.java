...
public class ValidationReportService {
    ...
    public void fileSizeReport() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(filePath))) {
            ...
            bw.write("<link rel='icon' type='image/png' href='vrn_favicon.png'>");
            ...
            bw.write("h2 { margin-left:15%; font-size: 20px; }");
            ...
            bw.write("<table>");
            bw.write(
                    "<thead><tr><th>SYSTEM</th><th>SUBSYSTEM</th><th>TYPE</th><th>ELEMENT</th><th>File Size (KB)</th></tr></thead>");
            bw.write("<tbody>");
            bw.newLine();
    ...
    public void fileCountReport() {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(filePath))) {
            ...
            bw.write("<!DOCTYPE html>");
            bw.newLine();
            bw.write("<html><head><meta charset='UTF-8'><title>File Count Report</title>");
            bw.write("<link rel='icon' type='image/png' href='vrn_favicon.png'>");
            bw.newLine();
            bw.write("<style>");
            bw.write("body { font-family: Arial; padding: 20px; }");
            ...
            bw.write("th { background-color: #333; color: white; }");
            bw.write("tr:nth-child(even) { background-color: #f2f2f2; }");
            bw.write("h2 { margin-left: 4%; font-size: 20px; }");
            bw.write("</style></head><body>");
            bw.newLine();
            ...
            while (cursor.hasNext()) {
                ...
                while (cursor1.hasNext()) {
                    ...
                    while (cursor2.hasNext()) {
                        ...
                        // === Local Count ===
                        File ElemFiledir = new File(
                                basePath + "\\" + "Sys_" + system + "\\" + "SubSys_" + subsystem + "\\" + type);
                        String[] ElemFile = ElemFiledir.list();
